...
type StaffForm = {
  ...
  role: "concierge" | "porter" | "supervisor" | "manager" | "maintenance";
        ...
        <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3 justify-end pt-2">
              ...
              <Button onClick={handleSubmit} className="bg-teal text-white hover:bg-teal/90" disabled={!form.name || !form.email || !form.hourlyRate}>
